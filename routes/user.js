...
const userRouter = (app) => {
  ...
  app.get('/api/user/:idUser/lastQuizes', middlewares.isCorrectToken(), userController.getLastQuizesPlayed);
  app.get('/api/user/:idUser/friends', middlewares.isCorrectToken(), userController.searchUserFriends);
